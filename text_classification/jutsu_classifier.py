  ...
  def __init__(self, 
    ...
    if not huggingface_hub.repo_exists(self.model_path):
      ...
      if data_path is None:
        raise ValueError("Data path is required to train the model, since the model path doesn't exists in HuggingFace!")
      ...
      class_weigths = get_class_weights(all_data)
      
      self.train_model(train_data, test_data, class_weigths)
